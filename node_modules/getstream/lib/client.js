...
var StreamClient = exports.StreamClient = /*#__PURE__*/function () {
  ...
  function StreamClient(apiKey, apiSecretOrToken, appId) {
    ...
    if (this.node) {
      var _this$options$keepAli, _this$options$httpAge, _this$options$httpsAg;
      var keepAlive = this.options.keepAlive === undefined ? true : this.options.keepAlive;
      var keepAliveMsecs = (_this$options$keepAli = this.options.keepAliveMsecs) !== null && _this$options$keepAli !== void 0 ? _this$options$keepAli : 3000;
      var agentOptions = {
        keepAlive: keepAlive,
      ...
      this.nodeOptions = {
        httpAgent: (_this$options$httpAge = this.options.httpAgent) !== null && _this$options$httpAge !== void 0 ? _this$options$httpAge : new http.Agent(agentOptions),
        httpsAgent: (_this$options$httpsAg = this.options.httpsAgent) !== null && _this$options$httpsAg !== void 0 ? _this$options$httpsAg : new https.Agent(agentOptions)
      };
    }
  ...
  return (0, _createClass2.default)(StreamClient, [{
