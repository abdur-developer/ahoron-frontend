...
export declare const isNumberOrString: (output: TDateTimeParserOutput) => output is number | string;
...
export declare function getDateString({ calendar, calendarFormats, format, formatDate, messageCreatedAt, relativeCompact, relativeCompactMaxDays, relativeCompactMaxWeeks, t, tDateTimeParser, timestampTranslationKey, }: DateFormatterOptions): string | number | null;
